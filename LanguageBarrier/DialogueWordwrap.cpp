...
// ゃ ゅ ょ ァ ィ ゥ ェ ォ ッ ャ ュ ョ – า ง ม ย ว ก ด น บ
static std::set<uint16_t> type1_punctuation = {
	...
	0x00F5, 0x00F6, 0x00F7, 0x00F8, 0x00F9, 0x00FA, 0x0113, 0x020E, 0x01E3,
	0x01FD, 0x01FE, 0x0203, 0x01DD, 0x01F0, 0x01F5, 0x01F6 };
...
0x00DA, 0x00DC, 0x0218, 0x0219,
0x021A, 0x021B, 0x021C };
